...
<template>
  ...
  <div>
    <header>
      <NuxtLink to="/"><svg width="41" height="45" viewBox="0 0 41 45" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <nav>
        ...
        <button class="btn4" @click="openModal" style="display: flex; align-items: center; gap: 4px;">Предложить проект<img src="/images/chevron-down.svg" style="width: 16px; transition-duration: 0.5s;" :class="{'svgopen' : isOpen }"></button>
      </nav>
    ...
    >
      ...
      <p>
        ...
        <a>персональных данных</a> и соглашаетесь с
...
.feedback {
  ...
  box-shadow: 4px 4px 50px 14px #999999;
  padding: 30px;
