<template>
   <NuxtLayout>
  <main ref="mainRef"> <!-- 1. Добавляем ссылку на контейнер -->
      ...
      <section class="conteiner">
        ...
        <div class="Aboutcount">
          ...
          <div>
            <h3>40<span class="wtfdesign">+</span></h3>
            <p>Проектеров</p>
          </div>
          <div>
            <h3>15</h3>
      ...
      <section class="conteiner">
        ...
        <a><button class="btn">Все проекты</button></a>
        <div class="swiper1">
...
<style>
  ...
  @import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Unbounded:wght@200..900&display=swap');
  </style>
